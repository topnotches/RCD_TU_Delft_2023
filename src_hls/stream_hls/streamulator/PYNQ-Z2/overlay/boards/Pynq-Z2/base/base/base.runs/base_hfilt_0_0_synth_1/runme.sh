...
HD_PWD='/home/topnotches/RCD_TU_Delft_2023/src_hls/stream_hls/streamulator/PYNQ-Z2/overlay/boards/Pynq-Z2/base/base/base.runs/base_hfilt_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_hfilt_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_hfilt_0_0.tcl
