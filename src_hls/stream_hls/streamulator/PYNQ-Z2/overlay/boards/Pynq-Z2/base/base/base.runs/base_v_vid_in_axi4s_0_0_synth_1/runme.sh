...
HD_PWD='/home/topnotches/RCD_TU_Delft_2023/src_hls/stream_hls/streamulator/PYNQ-Z2/overlay/boards/Pynq-Z2/base/base/base.runs/base_v_vid_in_axi4s_0_0_synth_1'
cd "$HD_PWD"
